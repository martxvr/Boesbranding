<?php
/* Template Name: Katholieke Jongerendag */
?>

<?php get_header(); // Laadt header.php ?>

<section class="afgelopen-reizen" style="height: auto;">
            <div class="ar-wp">
                <div class="afgelopen-reizen-container">
                    <div class="ar-wrapper">
                        <div class="k-logo"></div>
                        <div class="ar-box-1">
                            <h1>Katholieke Jongerendag</h1>
    ...
    <section class="img-text" style="width: 1000px;">
        <div class="img-kjd"></div>
        <div class="content-split">
            <h1 style="font-family: 'boes_branding_v2regular'; color: #525252; font-size: 48px; margin: 0px;">Katholieke Jongerendag</h1>
            <p style="font-family: 'blushes'; color: #525252; font-size: 18px;">Een modern event voor gelovige jongeren georganiseerd door gelovige jongeren. In een kerkgemeenschap in Ede komt deze community jaarlijks samen om het christelijke geloof te vieren. Om de promotie van het event te vernieuwen is KJD naar mij toegekomen met de volgende vraag;</p>
        </div>
    </section>

    <section class="p-wp">
        <p style="width: 670px; color: #fff; font-family: 'BlushesBlack'; font-size: 28px; text-align: center;">“Wij willen onze doelgroep bereiken door een  uitnodigend en jeugdig imago neerzetten.  Onze huidige branding past niet meer  bij deze uitstraling.”</p>
    </section>

    <section class="texture-content">
        <div class="texture-content-container">
            <div class="tc-images">
                <div class="tc-img1"></div>
                <div class="tc-img2"></div>
                <div class="tc-img3"></div>
            </div>
            <div class="tc-text">
                <p style="font-family: 'BlushesBold'; font-size: 24px;">Logo ontwerp</p>
                <p style="font-size: 18px;">Een combinatie van religieuze elementen (de vierpas & het kruis) gecombineerd met een modern lettertype en strakke vormen. Het originele logo weergeeft een liggend kruis dat symboliseert dat deze gedragen wordt door de generaties na Christus. Dit gevoel van saamhorigheid is een van de kernwaarden van de organisatie. Blauw is de primaire huisstijl kleur is gekozen door de associaties met het heilige. Door het modern en opvallend te houden is de tint fel en gesatureerd.</p>
            </div>
            <div class="tc-image2"></div>
            <div class="tc-text">
            <p style="font-family: 'BlushesBold'; font-size: 24px;">Illustraties</p>
            <p style="font-size: 18px;"> Dit zijn illustraties die religieuze elementen op een speelse en moderne manier weergeeft, Niet alles is symmetrisch of helemaal recht, dit voegt toe aan een jeugdige en speelse uitstraling. Ook hier komt het symbolisme uit het logo terug van het liggende kruis.  Uit ons onderzoek zijn we op een katholieke traditie getuimeld, de kruistocht.  Deze benadrukt het gevoel van saamhorigheid, een prominente kernwaarde van de organisatie.</p>
            </div>
        </div>
    ...
    <section class="white-bg-content">
        <div class="white-bg-container">
            <div class="tc-text" style="margin-top: 50px; padding: 50px;">
                <p style="font-family: 'BlushesBold'; font-size: 24px;">Merkhandleiding</p>
                <p style="font-size: 18px;">Om ervoor te zorgen dat alle uitingen binnen de organisatie in een lijn blijven is een merkhandleiding nodig. Tijdens het opmaak hiervan vormt het merk zich. Op dat moment worden dus ‘regels’ vastgelegd. Hoe moet het lettertype gebruikt worden? Welke kleuren combineren zich goed met elkaar? Hieronder krijg je een inkijkje. </p>
            </div>
            <iframe style="margin: 0 auto;" src="https://player.flipsnack.com?hash=RkZGQTk2OUM1QTgraDNzbzVpOXh1Mw==" width="100%" height="480" seamless="seamless" scrolling="no" frameBorder="0" allowFullScreen allow="autoplay; clipboard-read; clipboard-write"></iframe>
            <div class="white-bg-img-text">
            <div id="image-container" class="kjd-multiple-images"></div>
                <div class="white-bg-img-text-content">
                    <p style="font-family: 'BlushesBold'; font-size: 24px; margin: 0px;">Promotiemateriaal</p>
                    <p style="font-size: 18px;"> Voor de promotie van dit evenement hebben wij de organisatie voorzien van een flyer, poster en merchandise. De achterkant van de flyer geeft een inkijk in het programma in een kerkvorm gegoten. Deze promotiemiddelen zijn opgemaakt op basis van de merkhandleiding.</p>
                </div>
            </div>  
            <div class="kjd-img-1"></div>  
        </div>
    </section>
...
function toggleImageClass() {
    if (imageContainer.classList.contains("kjd-multiple-images")) {
        imageContainer.classList.remove("kjd-multiple-images");
        imageContainer.classList.add("kjd-img-2");
    } else {
        imageContainer.classList.remove("kjd-img-2");
        imageContainer.classList.add("kjd-multiple-images");
    }
}

// Start de wissel met een interval van 3 seconden
setInterval(toggleImageClass, 3000);
    </script>
...
<div class="moons-wp">
                <div class="afgelopen-reizen-container">
                    <div class="ar-wrapper">
                        ...
                        <div class="ar-box-1">
                            <h1 class="mobile-p-h1" style="color: #8391C8; font-family: Playfair Display, serif; font-weight: bold; font-style: normal; font-size: 58px; ">MOON'S<br> HUIDBALSEM </h1>
                            <p style="color: #8391C8; font-family: Playfair Display, serif; font-weight: bold; font-style: normal; font-size: 27px;">BRANDING & PROMOTIE & SOCIAL MEDIA</p>
...
<div class="laat-je-adviseren" style="background-image: none; background-color: #fff;">
...
<div class="lja-box-2">
    <h1 style="color: #006EB3; font-family: 'BlushesBlack';">Nina Boes</h1>
    <div class="jla-tel-box">
        <div class="tel-icon"></div>
        <a id="lja-tel" href="">+31  6 297 999 93</a>
    </div>
    <div class="lja-contact-box">
        <div class="p-lja-icon"></div>
        <a href="email" style="color: #525252;">info@boesbranding.com</a>
    </div>
</div>
