</main> <!-- Sluit de main sectie of content -->
...
<footer>
    <div class="footer-content" style="margin-top: 50px;">
        ...
        <div class="fc-2">
            <div class="f-contact">
                <h4 style="font-family: 'Cabin'">Contact</h4>
                <p>+31 6 29799993 <br>
                info@boesbranding.com</p>
            </div>
            <div class="f-social">
    ...
    <p style="color: #525252; text-align: center;">&copy; <?php echo date("Y"); ?> BOES Branding. Alle rechten voorbehouden.</p>
</footer>

<?php wp_footer(); // Zorgt ervoor dat plugins en scripts worden geladen ?>
